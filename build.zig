...
pub fn build(b: *std.Build) void {
    ...
    const module = b.addModule("phantom.display.ramfb", .{
    ...
    exe_example.root_module.addImport("phantom.display.ramfb", module);
    ...
    if (!no_tests) {
        ...
        unit_tests.root_module.addImport("fio", fio.module("fio"));
